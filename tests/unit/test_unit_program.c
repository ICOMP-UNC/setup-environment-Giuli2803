...
void test_logic_multiply(void)
{
    ...
    TEST_ASSERT_NOT_EQUAL(4,multiply(2,5));
}

void test_logic_divide(void)
{
    TEST_ASSERT_EQUAL(5.0,divide(10,2));
    TEST_ASSERT_NOT_EQUAL(-1.0,divide(10,2));
}

//Se llama ANTES ejecutar cada test. Se usa para inicializar variables
void setUp(void)
{
}

//Se llama DESPUES ejecutar cada test.
void tearDown(void)
{
}
